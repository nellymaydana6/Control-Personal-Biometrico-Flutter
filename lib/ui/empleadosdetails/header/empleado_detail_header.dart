...
import 'package:control_empleados/ui/empleadosdetails/header/diagonally_cut_colored_image.dart';
import 'package:flutter/material.dart';

import 'package:meta/meta.dart';

class EmpleadoDetailHeader extends StatelessWidget {
  static const BACKGROUND_IMAGE = 'images/profile_header_background.png';

  EmpleadoDetailHeader(
    this.empleado, {
  ...
  Widget _buildAvatar() {
    return new Hero(
      ...
      child: new CircleAvatar(
        backgroundImage: new NetworkImage(empleado.avatar),
        radius: 50.0,
      ),
    );
  }
